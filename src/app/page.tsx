...
const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'sentence-completion-word-list', title: 'Sentence completion (word list)', description: 'Complete a sentence using options A–J', category: 'Completion', filePath: '/data/questionType/sentence-completion/sentence-completion-word-list.example.json', questionType: 'sentence_completion', variant: 'sentence_completion_word_list' },
  ...
  { id: 'summary-completion-word-list', title: 'Summary completion (word list)', description: 'Complete a summary using options A–J', category: 'Completion', filePath: '/data/questionType/completion/summary-completion-word-list.example.json', questionType: 'completion', variant: 'summary_completion_word_list' },
